      ...
      <View style={ss.whiteContainer}>
        <SafeAreaView style={ss.invisiContainer}>
          <View style={[ss.invisiContainer, ss.padding15, {alignItems: 'center'}]}>
            ...
            <Text style={[ss.subHeader, ss.fullWidth, ss.addViewSpacing]}>We actually haven't built out any subscription content yet. We're currently trying to gauge the level of interest.</Text>
