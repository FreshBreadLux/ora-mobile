...
class KeyContainer extends React.Component {
  ...
  animateUnlock() {
    Animated.sequence([
      Animated.parallel([
        Animated.timing(this.state.keyRing1Top, {toValue: 12.2309505, duration: 800, delay: 200}),
        Animated.timing(this.state.keyRing2Top, {toValue: 12.2309505, duration: 800, delay: 200}),
      ]),
      Animated.parallel([
        Animated.timing(this.state.keyRing1Angle, {toValue: -135, duration: 700, delay: 300}),
        Animated.timing(this.state.keyRing1Left, {toValue: 6.21320344, duration: 700, delay: 300}),
        Animated.timing(this.state.keyRing1Top, {toValue: 42.8672427, duration: 700, delay: 300}),
        Animated.timing(this.state.keyRing2Angle, {toValue: 135, duration: 700, delay: 300}),
        Animated.timing(this.state.keyRing2Left, {toValue: 53.7867966, duration: 700, delay: 300}),
        Animated.timing(this.state.keyRing2Top, {toValue: 42.8672427, duration: 700, delay: 300}),
        Animated.timing(this.state.keyHead1Angle, {toValue: 45, duration: 700, delay: 300}),
        Animated.timing(this.state.keyHead1Left, {toValue: 6.21320344, duration: 700, delay: 300}),
        Animated.timing(this.state.keyHead1Top, {toValue: 17.25, duration: 700, delay: 300}),
        Animated.timing(this.state.keyHead2Angle, {toValue: -45, duration: 700, delay: 300}),
        Animated.timing(this.state.keyHead2Left, {toValue: 62.5770559, duration: 700, delay: 300}),
        Animated.timing(this.state.keyHead2Top, {toValue: 17.25, duration: 700, delay: 300}),
        Animated.timing(this.state.keyMid1Angle, {toValue: -45, duration: 700, delay: 300}),
        Animated.timing(this.state.keyMid1Left, {toValue: 31.4999277, duration: 700, delay: 300}),
        Animated.timing(this.state.keyMid1Top, {toValue: 33, duration: 700, delay: 300}),
        Animated.timing(this.state.keyMid2Angle, {toValue: 45, duration: 700, delay: 300}),
        Animated.timing(this.state.keyMid2Left, {toValue: 16, duration: 700, delay: 300}),
        Animated.timing(this.state.keyMid2Top, {toValue: 33, duration: 700, delay: 300}),
        Animated.timing(this.state.keyEnd1Angle, {toValue: -45, duration: 700, delay: 300}),
        Animated.timing(this.state.keyEnd1Left, {toValue: 11.5, duration: 700, delay: 300}),
        Animated.timing(this.state.keyEnd1Top, {toValue: 7.5, duration: 700, delay: 300}),
        Animated.timing(this.state.keyEnd2Angle, {toValue: -315, duration: 700, delay: 300}),
        Animated.timing(this.state.keyEnd2Left, {toValue: 73.8, duration: 700, delay: 300}),
        Animated.timing(this.state.keyEnd2Top, {toValue: 7.5, duration: 700, delay: 300}),
      ])
