...
const EnableNotificationsPresenter = ({ scroll, updateUserWithNotificationToken }) => (
  <SafeAreaView style={ss.invisiContainer}>
    <Text style={[ss.tagLine, ss.centerText, ss.padding10, {marginTop: 30}]}>It's important to be able to send and receive prayer notifications in Ora. Tap below to enable prayer notifications.</Text>
