...
const IntroReminderPromptPresenter = ({ scrollByOne, navigation }) => (
  <SafeAreaView style={ss.invisiContainer}>
    <Text style={[ss.tagLine, ss.centerText, ss.padding10, {fontFamily: 'ralewayBold', marginTop: 30}]}>Before getting started, set a daily prayer reminder</Text>
    <View style={ss.center}>
      ...
      <TouchableOpacity onPress={scrollByOne}>
