...
const SubmitTitlePresenter = ({ navigation, title, dispatchSetAnonymousTitle }) => (
  <View style={[ss.invisiContainer]}>
    <Text style={[ss.subBody, ss.padding10]}>Give your prayer a title</Text>
    <TextInput
      ...
      onSubmitEditing={() => {
        if (title.length) navigation.navigate('SubmitBody')
      }} />
